...
results_df = spark.read.parquet(f"{processed_folder_path}/output") \
...
# MAGIC %md
# MAGIC ###Join results to the other data frames
# MAGIC Multiple join implemented
# MAGIC
...
final_df.write.mode("overwrite").parquet(f"{presentation_folder_path}/output")
